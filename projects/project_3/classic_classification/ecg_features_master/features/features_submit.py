...
# Local imports
from ecg_features_master.features.full_waveform_statistics import *
from ecg_features_master.features.heart_rate_variability_statistics import *
from ecg_features_master.features.template_statistics import *
from ecg_features_master.utils.plotting.waveforms import plot_waveform



class FeaturesSubmit:
    ...
    def __init__(self, fs, feature_groups, labels=None):
    ...
    def calculate_features(self, raw_data, point_id, filter_bandwidth, show=False,
        ...
        # Print progress
        if show:
            print('Working on point id: ' + point_id + ' feature extraction.')
    ...
    def _group_features(self, point_id, ts, signal_raw, signal_filtered, rpeaks,
